...
for (const file of ['js/utils.js', 'js/fx.js', 'js/config.js', 'js/run-state.js', 'js/attacks.js', 'js/spawns.js', 'js/sprites.js', 'js/entities.js', 'js/weapons.js', 'js/game-spawning.js', 'js/game-collision.js', 'js/game-encounter.js', 'js/game-progression.js', 'js/game.js']) {
